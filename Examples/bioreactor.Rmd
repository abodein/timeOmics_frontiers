...
cat("Ther are", nrow(pc.abundance.sel), "OTUs after", percent, "% filter")

```

# Spline smoothing

All the data are modelled with spline smoothing. 
...
16S data and metabolites are analysed. 
